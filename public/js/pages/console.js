/**
 * Moodcar Console Dashboard Interactive Scripts (console.js)
 * 관리자 콘솔 조작 스크립트입니다.
 */
...
window.updateInquiryStatus = async (id, select) => {
  ...
  try {
    // /admin/inquiry/update-status -> /console/inquiry/update-status 로 변경
    const response = await fetch('/console/inquiry/update-status', {
      method: 'POST',
